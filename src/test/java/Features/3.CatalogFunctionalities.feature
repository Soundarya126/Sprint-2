Feature: Tesing Catalog Functionalities
  ...
  Scenario: Testing Categories under catalog
    ...
    Then categories "categories completed moving to products"
  ...
  Scenario: Testing Products under catalog
    ...
    Then Products "products completed moving to recurring profiles"
  ...
  Scenario: Testing Recurring profiles under catalog
    ...
    Then Recurring  "recurring profiles completed moving to Filters"
  ...
  Scenario: Testing Filters under catalog
    ...
    Then Filters "Filters completed moving to Attributes"
  ...
  Scenario: Testing Attributes under catalog
    ...
    Then Attributes "Attributes completed moving to Attribute Group"
  ...
  Scenario: Testing Attribute Group under catalog
    ...
    Then Group "Attribute Group completed moving to Options"
  ...
  Scenario: Testing Options under catalog
    ...
    Then Options "Options completed moving to Options"
  ...
  Scenario: Testing Manufacturers under catalog
    ...
    Then manufac "Options completed moving to Downloads"
  ...
  Scenario: Testing Downloads under catalog
    ...
    Then download "Downloads completed moving to Reviews"
  ...
  Scenario: Testing Reviews under catalog
    ...
    Then reviews "Reviews completed moving to Information"
  ...
  Scenario: Testing Reviews under Information
    ...
    Then info "Catalog is completed next is sales"
