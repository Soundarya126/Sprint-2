...

{
	...
	public void browsersetup()
	{
		...
		action = new Actions(driver);  // creating action
	...
	@Given("^(.*) and (.*) url$")
	public void and_url(String valid, String invalid) 
	{
	...
	//login  also used in background
	 ...
	 @Given("^admin page login with (.*) and (.*)$")
	    public void admin_page_login_with_and(String username, String password) 
	 {
		 driver.findElement(By.id("input-username")).sendKeys(username);  // user name
	 ...
	 @Given("^go to \"([^\"]*)\"$")
	 public void go_to_something(String strArg1)
	 {
		 driver.get(strArg1); 
	...
	public void user_at_login_page() throws IOException
	{
		...
		String url = "http://retailm1.upskills.in/admin/";
	...
	public void user_clicks_on_sidebar() 
	{
	 ...
	 @Then("^visibile \"([^\"]*)\"$")
	 public void visibile_something(String strArg1) 
	 {
		 sidebar.click();
	...
	public void check_delete_option_both_single_and_multiple_in_categories_list() 
	{
	 ...
	 @Then("^categories \"([^\"]*)\"$")
	 public void categoriesmsg(String strArg1) throws Throwable 
	 {
		 System.out.println(strArg1);  
	 }
	...
	@Then("^Products \"([^\"]*)\"$")
	 public void productmsg(String strArg1) throws Throwable 
	 {
		 System.out.println(strArg1);  
	 }
	...
	public void check_delete_option_both_single_and_multiple_in_recurring_profile_list()
	{
	 ...
	 @Then("^Recurring  \"([^\"]*)\"$")
	 public void recurringmsg(String strArg1) throws Throwable 
	 {
		 System.out.println(strArg1);  
	 }
	...
	@Then("^Filters \"([^\"]*)\"$")
	 public void filtersmsg(String strArg1) throws Throwable 
	 {
		 System.out.println(strArg1);  
	 }
	...
	@Then("^Attributes \"([^\"]*)\"$")
	 public void attributesmsg(String strArg1) throws Throwable 
	 {
		 System.out.println(strArg1);  
	 }
	...
	@Then("^Group \"([^\"]*)\"$")
	 public void groupmsg(String strArg1) throws Throwable 
	 {
		 System.out.println(strArg1);  
	 }
	...
	@Then("^Options \"([^\"]*)\"$")
	 public void optionsmsg(String strArg1) throws Throwable 
	 {
		 System.out.println(strArg1);  
	 }
	...
	@Then("^manufac \"([^\"]*)\"$")
	 public void manufacturersmsg(String strArg1) throws Throwable 
	 {
		 System.out.println(strArg1);  
	 }
	...
	@Then("^download \"([^\"]*)\"$")
	 public void downloadmsg(String strArg1) throws Throwable 
	 {
		 System.out.println(strArg1);  
	 }
	...
	@Then("^reviews \"([^\"]*)\"$")
	 public void reviewmsg(String strArg1) throws Throwable 
	 {
		 System.out.println(strArg1);  
	 }
	...
	@Then("^info \"([^\"]*)\"$")
	 public void informationmsg(String strArg1) throws Throwable 
	 {
		 System.out.println(strArg1);  
	 }
	...
	// -------------------  Background Testing  --------------------- \\
		...
		{
			//checking sidebar functionality
			
			WebElement sidebar = driver.findElement(By.id("button-menu")) ;   
			sidebar.click();
		}
		...
		public void user_select_orders_under_sales() 
		{
			...
			driver.findElement(By.xpath("//*[@id='menu-sale']/ul/li[1]")).click(); 
		...
		public void fill_details_orders()
		{
			...
			add_product = driver.findElement(By.xpath("//*[@id='tab-product']//div//button")); 
			
			//clicks on Continue and moves to payment page
			
			Continue1 = driver.findElement(By.xpath("//*[@id='tab-cart']//div[3]//div[2]//button"));    
			...
			//clicks on continue and moves to shipping page
			
			driver.findElement(By.xpath("//*[@id='tab-payment']//div[12]//div[2]//button")).click();   
			...
			s2.selectByIndex(1489);
			 ...
			 //clicks on Continue and moves to totals page
			
			driver.findElement(By.xpath("//*[@id='tab-shipping']//div[12]//div[2]//button")).click();  
			...
			st.selectByVisibleText("Free Shipping");
			 ...
			 //click on apply for shipping method
			...
			// click on apply for payment method
			
			driver.findElement(By.xpath("//*[@id='tab-total']//div[2]//span//button")).click();  
		 ...
		 @Then("^orders1 \"([^\"]*)\"$")
		 public void orders1msg(String strArg1) 
		 {
			 System.out.println(strArg1);
		 }
		...
		public void deletion_of_single_order() 
		{
			...
			for(int i=1;i==1;i++)
			{
				for(int j=1;j==1;j++)
				{
					//checks on single box
					
					driver.findElement(By.xpath("//*[@id='form-order']/div/table/tbody/tr["+ i +"]/td["+ j +"]")).click();  
				}
			}
		...
		public void filtering() 
		{
			...
			//displays all the orders by the name manzoor mehadi
			
			driver.findElement(By.id("button-filter")).click();  
		}
		
		@Then("^orders2 \"([^\"]*)\"$")
		 public void orders2msg(String strArg1) 
		 {
			 System.out.println(strArg1);
		 }

		// ------------------------------------- Testing on Recurring Profiles -------------------------------- \\
		...
		public void user_selects_recurring_profiles_under_sales() 
		{
			...
			//click on Recurring Profiles
			
			driver.findElement(By.xpath("//*[@id='menu-sale']//ul//li[2]//a")).click();     
		}
		...
		@Then("^Recurring \"([^\"]*)\"$")
		public void recurring(String strArg1)
		{
			System.out.println(strArg1);
		}
		...
		{
			 //clicks on add new return details
		...
		public void deletion_of_single_return() 
		{
			for(int i=1;i==1;i++)
			{
				for(int j=1;j==1;j++)
				{
					...
					driver.findElement(By.xpath("//*[@id='form-return']/div/table/tbody/tr["+ i +"]/td["+ j +"]")).click();  
				}
			}
		...
		public void filtering_the_returns() 
		{
			...
			//displays all the returns by the name anju
			
			driver.findElement(By.id("button-filter")).click();   
		}
		
		@Then("^Returns \"([^\"]*)\"$")
	    public void returns(String strArg1)
	    { 
	       System.out.println(strArg1);
	    }


		// --------------------------------- Testing Gift_vouchers_section -------------------------------- \\
		...
		public void user_selects_voucher_themes_under_sales() 
		{
			...
			driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
			 ...
			 //clicks on gift vouchers
			
			driver.findElement(By.xpath("//*[@id='menu-sale']//ul//li[4]")).click();  
		}

		@When("add new theme")
		public void add_new_theme() 
		{
			//clicks on voucher theme
			
			driver.findElement(By.xpath("//*[@id='menu-sale']//ul//li[4]//ul//li[2]")).click(); 
			...
			driver.findElement(By.xpath("//*[@id='filemanager']//div[5]//div[3]//a")).click();   
		...
		public void user_can_delete_single_or_multiple_themes() 
		{
			...
			for(int i=2;i==2;i++)
			{
				for(int j=2;j==2;j++)
				{
					...
					driver.findElement(By.xpath("//*[@id='form-voucher-theme']/div/table/tbody/tr["+ i +"]/td["+ j +"]")).click();  
				}
			}
		...
		public void fill_voucher_details() 
		{
			...
			driver.findElement(By.xpath("//*[@id='menu-sale']//ul//li[4]//ul//li[1]")).click(); 
			
			//add new voucher button
			
			driver.findElement(By.xpath("//*[@id='content']//div[1]/a")).click();        
			driver.findElement(By.id("input-code")).sendKeys("Major109");
		...
		public void mail_the_voucher_details() 
		{
			for(int i=1;i==1;i++)
			{
				for(int j=1;j==1;j++)
				{
					...
					driver.findElement(By.xpath("//*[@id='form-voucher']/div/table/tbody/tr["+ i +"]/td["+ j +"]")).click();  
				}
			}
		...
		@Then("^Gift Vouchers \"([^\"]*)\"$")
	    public void gift_vouchers(String strArg1)
	    {
	        System.out.println(strArg1);
	    }
		...
		{
			//clicks on Customers in sidebar
		...
		public void user_select_customers_under_customers() 
		{
			...
			driver.findElement(By.xpath("//*[@id='menu-customer']//ul//li[1] ")).click();    
		}
		...
		public void delete_single_customer_detail() 
		{
			for(int i=1;i==1;i++)
			{
				for(int j=1;j==1;j++)
				{
					...
					driver.findElement(By.xpath("//*[@id='form-customer']/div/table/tbody/tr["+ i +"]/td["+ j +"]")).click();  
				}
			}
		...
		public void filter_the_customer_list() 
		{
			...
			//displays all the details of manzoor mehadi

			driver.findElement(By.id("button-filter")).click();  
		}
		@Then("^Customers \"([^\"]*)\"$")
		public void customers(String strArg1) 
		{
			System.out.println(strArg1);
		...
		public void user_selects_customer_groups_under_customers() 
		{
			...
			//clicks on customer groups

			driver.findElement(By.xpath("//*[@id='menu-customer']//ul//li[2]")).click();   
		...
		public void delete_single_group() 
		{
			for(int i=1;i==1;i++)
			{
				for(int j=1;j==1;j++)
				{
					...
					driver.findElement(By.xpath("//*[@id='form-customer-group']/div/table/tbody/tr["+ i +"]/td["+ j +"]")).click();  
				}
			}
		...
		@Then("^Customer Group \"([^\"]*)\"$")
		public void customer_group(String strArg1) 
		{
			System.out.println(strArg1);
		...
		public void user_selects_custom_fields_under_customers() 
		{
			...
			driver.findElement(By.xpath("//*[@id='menu-customer']//ul//li[3]")).click();    
		}
		...
		public void delete_single_field() 
		{
			for(int i=1;i==1;i++)
			{
				for(int j=1;j==1;j++)
				{
					...
					driver.findElement(By.xpath("//*[@id='form-custom-field']/div/table/tbody/tr["+ i +"]/td["+ j +"]")).click();  
				}
			}
		...
		@Then("^Custom fields \"([^\"]*)\"$")
		public void custom_fields(String strArg1) 
		{
			System.out.println(strArg1);
	...
	public void click_0n_filter()
	{
	 ...
	 @Then("^market \"([^\"]*)\"$")
	 public void marketmsg(String strArg1) throws Throwable 
	 {
		 System.out.println(strArg1);
	 }
	...
	@Then("^aff \"([^\"]*)\"$")
    public void aff_something(String strArg1) throws Throwable 
	{
        System.out.println(strArg1);
    }
	...
	@Then("^cou \"([^\"]*)\"$")
    public void cou_something(String strArg1) throws Throwable
    {
        System.out.println(strArg1);
    }
	...
	@Then("^mail \"([^\"]*)\"$")
    public void mail_something(String strArg1) throws Throwable 
    {
        System.out.println(strArg1);
    }
	...
	@Then("^sal \"([^\"]*)\"$")
	    public void sal_something(String strArg1) throws Throwable  
	    {
	        System.out.println(strArg1);
	    }
	...
	@Then("^ship \"([^\"]*)\"$")
    public void ship_something(String strArg1) throws Throwable 
    {
        System.out.println(strArg1);
    }
	...
	public void click_0n_filter5()
	{
	 ...
	 @Then("^Ret \"([^\"]*)\"$")
	    public void ret_something(String strArg1) throws Throwable 
	    {
	        System.out.println(strArg1);
	    }
	...
	@Then("^vie \"([^\"]*)\"$")
    public void vie_something(String strArg1) throws Throwable 
    {
        System.out.println(strArg1);
    }
	...
	@Then("^pur \"([^\"]*)\"$")
    public void pur_something(String strArg1) throws Throwable 
    {
        System.out.println(strArg1);
    }
	...
	@Then("^ord \"([^\"]*)\"$")
    public void ord_something(String strArg1) throws Throwable 
    {
       System.out.println(strArg1);
    }
	...
	@Then("^cred \"([^\"]*)\"$")
    public void cred_something(String strArg1) throws Throwable
    {
        System.out.println(strArg1);
    }
